...
public final class QueryUtils {
    ...
    public static ArrayList<details> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject newjsonObject=new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray featuresArray=newjsonObject.getJSONArray("features");
            ...
            for (int i=0;i<featuresArray.length();i++){
                ...
                Date currentItemDate= new Date(time);
                SimpleDateFormat dateFormatter=new SimpleDateFormat("DD MM, YYYY");
                String dateToDisplay=dateFormatter.format(currentItemDate);

                //String time=properties.getString("time");

                details earthquake=new details(magnitude,place,dateToDisplay);
